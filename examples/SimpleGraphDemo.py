...
for graph_id in range(args.number_of_examples):
    graphs_train.set_number_of_graph_nodes(graph_id, 4)#np.random.randint(2, args.max_sequence_length+1))
...
for graph_id in range(args.number_of_examples):
    graphs_test.set_number_of_graph_nodes(graph_id, 4)#np.random.randint(2, args.max_sequence_length+1))
